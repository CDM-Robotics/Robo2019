...
public class RobotConfig {
    ...
    public static final int ELV_TICKS_PER_INCH = 370; // MEASURED 2019 4 -4 
    public static final double ELV_BASE_PERCENT_OUT = 0.1;
    ...
    public static final double WRIST_BASE_PERCENT_OUT = 0.2;
